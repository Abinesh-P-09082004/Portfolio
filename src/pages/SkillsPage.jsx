...
// --- INLINE SVG ICONS (Defined in App.jsx in the previous step, included here for context) ---
...
const IconBookOpen = ({ size = 30 }) => (<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>);
...
const IconAccessTime = ({ size = 30 }) => (<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>);
...
const IconWeb = ({ size = 30 }) => (<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" x2="22" y1="12" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>);

const ABINESH_SKILLS = [
  { name: 'HTML, CSS.', icon: <IconHTML />, description: 'Practical experience as well as front-end development based on HTML and CSS.' },
  { name: 'JAVASCRIPT.', icon: <IconCode />, description: 'Expertise in building interactive and dynamic web applications logic.' },
  { name: 'React JS.', icon: <IconComputer />, description: 'Skilled in developing robust single-page applications using React.' },
  { name: 'App development.', icon: <IconDraftingCompass />, description: 'Proficient in designing and developing mobile applications.'  },
  { name: 'IoT.', icon: <IconMicroscope />, description: 'Knowledge in Foundation of Cloud, IoT, and Edge computing systems.' },
  { name: 'Management Skill.', icon: <IconChartBar />, description: 'Effective at managing tasks, time, and team collaboration.'  },
  { name: 'Communication Skill.', icon: <IconUserSecret />, description: 'Strong interpersonal and technical communication abilities.'  },
];
